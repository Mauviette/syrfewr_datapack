execute if score @s gw.estMort matches 1.. run function glasswar:playing/death
...
execute unless score @s gw.temp matches 1.. run give @s bow[minecraft:custom_data={starting_bow:1,to_kill:1},minecraft:unbreakable={show_in_tooltip:false}]
