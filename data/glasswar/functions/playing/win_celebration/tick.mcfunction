...
execute if score @s s.SelectedVictoryAnimationID matches 2 run setblock ~ ~-1 ~ gold_block
...
execute if score @s s.SelectedVictoryAnimationID matches 3 run particle minecraft:dragon_breath ~ ~1.2 ~ 0.1 0.1 0.1 .4 5 force
execute if score @s s.SelectedVictoryAnimationID matches 3 run particle minecraft:dragon_breath ~ ~1.2 ~ 0.1 0.1 0.1 .2 1 force

execute if score @s s.SelectedVictoryAnimationID matches 4 run item replace entity @s weapon.offhand with tnt 64
execute if score @s s.SelectedVictoryAnimationID matches 4 run setblock ~ ~-1 ~ tnt
execute if score @s s.SelectedVictoryAnimationID matches 4 run setblock ~ ~-2 ~ tnt
