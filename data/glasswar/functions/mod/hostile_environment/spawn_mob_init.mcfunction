execute store result storage glasswar.temp x double 1 run random value -1..1
execute store result storage glasswar.temp y double 1 run random value 1..3
execute store result storage glasswar.temp z double 1 run random value -1..1
...
scoreboard players set @s gw.ModificatorTimer 400
