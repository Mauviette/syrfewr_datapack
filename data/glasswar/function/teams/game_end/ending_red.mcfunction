...
execute if score @s gw.GameTimer matches 299 run title @a[distance=..350] times 0 8s 0
execute if score @s gw.GameTimer matches 299 run title @a[distance=..350] title {"text":"L'équipe rouge","color":"red"}
