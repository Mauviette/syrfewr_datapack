...
data modify entity @e[type=small_fireball,tag=gw.projectile_fireball,limit=1,sort=nearest] Motion set from entity @e[type=marker,tag=gw.direction_fireball,limit=1] Pos
data modify entity @e[type=small_fireball,tag=gw.projectile_fireball,limit=1,sort=nearest] acceleration_power set value 1
