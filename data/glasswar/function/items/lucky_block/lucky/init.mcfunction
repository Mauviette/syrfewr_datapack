...
data merge entity @s {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.95f,0.95f,0.95f]},item:{id:"minecraft:ghast_spawn_egg",count:1,components:{"minecraft:custom_model_data":2}}}
