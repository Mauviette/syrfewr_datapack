execute if score @s gw.NumberOfPlayers matches 1 run function glasswar:ffa/game_creation/init_area/ffa/1
execute if score @s gw.NumberOfPlayers matches 2 run function glasswar:ffa/game_creation/init_area/ffa/2
execute if score @s gw.NumberOfPlayers matches 3 run function glasswar:ffa/game_creation/init_area/ffa/3
