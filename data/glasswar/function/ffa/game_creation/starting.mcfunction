...
execute if score @s gw.GameTimer matches 15 run title @a[tag=gw.starting_confirmed] times 0 45 0
execute if score @s gw.GameTimer matches 15 run title @a[tag=gw.starting_confirmed] actionbar [{"text":"Chargement de la partie...","color":"white"}]
...
execute if score @s gw.GameTimer matches 10 run tp @a[tag=gw.starting_confirmed] @s

execute if score @s gw.GameTimer matches 10 run tag @a[tag=gw.starting_confirmed] add gw.starting_end
execute if score @s gw.GameTimer matches 10 run tag @a[tag=gw.starting_confirmed] remove gw.starting_confirmed
