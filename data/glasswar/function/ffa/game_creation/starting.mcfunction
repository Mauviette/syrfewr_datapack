...
execute if score @s gw.GameTimer matches 1 if score @s gw.ModificatorID matches 1.. run scoreboard players set @a[tag=gw.playing,distance=..250] gw.timeSinceDeath 0
