...
execute if score @s s.GuiPageID matches 28 if score @s s.GuiIndexID matches 1 unless data entity @s {Inventory:[{Slot:14b,components:{"minecraft:custom_data":{select:1}}}]} run function syrfewr:player/personal_gui/more/fishing/stuff/fishing_rods/clicked/twisted
execute if score @s s.GuiPageID matches 28 if score @s s.GuiIndexID matches 1 unless data entity @s {Inventory:[{Slot:15b,components:{"minecraft:custom_data":{select:1}}}]} run function syrfewr:player/personal_gui/more/fishing/stuff/fishing_rods/clicked/hardened
