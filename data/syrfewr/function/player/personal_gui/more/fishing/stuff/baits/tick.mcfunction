...
execute if score @s s.GuiPageID matches 28 if score @s s.GuiIndexID matches 3 unless data entity @s {Inventory:[{Slot:12b,components:{"minecraft:custom_data":{select:1}}}]} run function syrfewr:player/personal_gui/more/fishing/stuff/baits/clicked/magnet
execute if score @s s.GuiPageID matches 28 if score @s s.GuiIndexID matches 3 unless data entity @s {Inventory:[{Slot:13b,components:{"minecraft:custom_data":{select:1}}}]} run function syrfewr:player/personal_gui/more/fishing/stuff/baits/clicked/obscure
