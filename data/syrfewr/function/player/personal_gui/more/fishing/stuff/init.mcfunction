...
item replace entity @s inventory.26 with barrier[minecraft:custom_model_data=105,custom_data={ui:1,item_from_more:1,to_kill:1,box:1},item_name='{"text":""}',hide_tooltip={}]
