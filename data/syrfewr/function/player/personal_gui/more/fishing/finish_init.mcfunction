...
$execute if score @s s.bait_duration matches 1.. run item replace entity @s inventory.12 with fishing_rod[custom_data={ui:1,item_from_more:1,to_kill:1,stuff:1},item_name='{"color":"white","text":"Équipement de pêche"}',lore=['{"text":"$(discovered_rods)/$(total_rods) cannes à pêche","color":"dark_gray","italic":false}','{"text":"$(discovered_hooks)/$(total_hooks) hameçons","color":"dark_gray","italic":false}','{"text":"$(discovered_baits)/$(total_baits) hameçons","color":"dark_gray","italic":false}','[{"text":"Appât actif : ","color":"dark_gray","italic":false},$(active_bait)]','$(bait_uses)']]

$execute unless score @s s.bait_duration matches 1.. run item replace entity @s inventory.12 with fishing_rod[custom_data={ui:1,item_from_more:1,to_kill:1,stuff:1},item_name='{"color":"white","text":"Équipement de pêche"}',lore=['{"text":"$(discovered_rods)/$(total_rods) cannes à pêche","color":"dark_gray","italic":false}','{"text":"$(discovered_hooks)/$(total_hooks) hameçons","color":"dark_gray","italic":false}','{"text":"$(discovered_baits)/$(total_baits) hameçons","color":"dark_gray","italic":false}','[{"text":"Appât actif : ","color":"dark_gray","italic":false},$(active_bait)]']]
