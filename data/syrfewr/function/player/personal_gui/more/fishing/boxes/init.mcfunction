...
item replace entity @s inventory.18 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_more:1,to_kill:1,back:1},item_name='{"color":"white","text":"Retour"}']
item replace entity @s inventory.26 with barrier[custom_model_data={strings:['main_menu']},custom_data={ui:1,item_from_more:1,to_kill:1,more:1},item_name='{"text":""}',hide_tooltip={}]
