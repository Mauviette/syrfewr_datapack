...
item replace entity @s inventory.0 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_lootboxes:1,to_kill:1,trouvailles:1},item_name='{"color":"white","text":"Trouvailles"}',lore=['{"color":"dark_gray","text":"Clic pour voir le contenu des trouvailles","italic":true}']]

item replace entity @s inventory.18 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_lootboxes:1,to_kill:1,back_to_more:1},item_name='{"color":"white","text":"Retour"}']

item replace entity @s inventory.26 with barrier[minecraft:custom_model_data={strings:['lootboxes']},custom_data={ui:1,item_from_lootboxes:1,to_kill:1,lootboxes:1},item_name='{"text":""}',hide_tooltip={}]
