...
item replace entity @s inventory.26 with barrier[minecraft:custom_model_data=106,custom_data={ui:1,item_from_lootboxes:1,to_kill:1,lootboxes:1},item_name='{"text":""}']
