...
item replace entity @s inventory.18 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_settings:1,to_kill:1,back_to_more:1},item_name='{"color":"white","text":"Retour (plus)"}']

item replace entity @s inventory.26 with barrier[custom_model_data={strings:['gamemodes']},custom_data={ui:1,item_from_settings:1,to_kill:1,settings:1},item_name='{"text":""}']
