...
execute if score @s s.favoriteColor matches 11 run item replace entity @s inventory.1 with orange_dye[custom_data={item_from_settings:1,to_kill:1,favorite_color:1},item_name='{"text":"Orange","color":"gold"}',lore=['{"text":"Couleur preférée","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}']]
execute if score @s s.favoriteColor matches 12 run item replace entity @s inventory.1 with brown_dye[custom_data={item_from_settings:1,to_kill:1,favorite_color:1},item_name='{"text":"Marron","color":"dark_red"}',lore=['{"text":"Couleur preférée","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}']]
...
execute if score @s s.playerGender matches 1 run item replace entity @s inventory.2 with player_head[custom_data={item_from_settings:1,to_kill:1,player_gender:1},item_name='{"text":"Masculin","color":"blue"}',lore=['{"text":"Genre","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}']]
execute if score @s s.playerGender matches 2 run item replace entity @s inventory.2 with player_head[custom_data={item_from_settings:1,to_kill:1,player_gender:1},item_name='{"text":"Féminin","color":"red"}',lore=['{"text":"Genre","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}'],profile={properties:[{value:eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHBzOi8vcy5uYW1lbWMuY29tL2kvYjNjMjAwOTQwMzg3MDJjNi5wbmcifX19,name:textures}]}]
execute if score @s s.playerGender matches 3 run item replace entity @s inventory.2 with player_head[custom_data={item_from_settings:1,to_kill:1,player_gender:1},item_name='{"text":"Neutre","color":"yellow"}',lore=['{"text":"Genre","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}'],profile={name:nonbinary}]



execute unless score @s s.computerPower matches 1.. run scoreboard players set @s s.computerPower 2
#1: patate, 2: medium, 3: ultra
execute if score @s s.computerPower matches 1 run item replace entity @s inventory.3 with potato[custom_data={item_from_settings:1,to_kill:1,computer_power:1},item_name='{"text":"Patate","color":"red"}',lore=['{"text":"Puissance de l\'ordinateur","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}']]
execute if score @s s.computerPower matches 2 run item replace entity @s inventory.3 with iron_ingot[custom_data={item_from_settings:1,to_kill:1,computer_power:1},item_name='{"text":"Medium","color":"gray"}',lore=['{"text":"Puissance de l\'ordinateur","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}']]
execute if score @s s.computerPower matches 3 run item replace entity @s inventory.3 with diamond[custom_data={item_from_settings:1,to_kill:1,computer_power:1},item_name='{"text":"Ultra","color":"aqua"}',lore=['{"text":"Puissance de l\'ordinateur","color":"gray","italic":false}','{"text":"Clic pour changer","color":"dark_gray"}']]
