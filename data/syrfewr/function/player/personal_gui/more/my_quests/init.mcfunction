...
item replace entity @s inventory.8 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_mq:1,to_kill:1,missions:1},item_name='{"color":"white","text":"Missions"}',lore=['{"text":"Quêtes données par des PNJ","color":"dark_gray","italic": false}']]

item replace entity @s inventory.18 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_mq:1,to_kill:1,back_to_more:1},item_name='{"color":"white","text":"Retour (plus)"}']
