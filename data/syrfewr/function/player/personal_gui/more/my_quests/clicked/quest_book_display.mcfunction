execute unless data entity @s {Inventory:[{Slot:10b,components:{"minecraft:custom_data":{quest_book_display:1}}}]} if entity @s[advancements={syrfewr:quests/my_first_cosmetic/4=true}] if entity @s[advancements={syrfewr:quests/my_first_cosmetic/4_claim=false}] if entity @s[advancements={syrfewr:quests/my_first_cosmetic/3_claim=true}] run advancement grant @s only syrfewr:quests/my_first_cosmetic/4_claim
