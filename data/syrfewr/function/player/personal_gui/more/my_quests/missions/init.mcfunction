...
item replace entity @s inventory.18 with barrier[custom_model_data=3,custom_data={ui:1,item_from_m:1,to_kill:1,back_to_more:1},item_name='{"color":"white","text":"Retour (quêtes)"}']

item replace entity @s inventory.26 with barrier[minecraft:custom_model_data=102,custom_data={ui:1,item_from_m:1,to_kill:1,missions:1},item_name='{"text":""}']
