...
execute if entity @s[advancements={syrfewr:succes/skins/hats/cookie=false}] if score @s s.TimeSinceLastObjectSelection matches ..30 if score @s s.SelectedObjectID matches 10 if score @s s.credits >= #hat_mythic price run function syrfewr:player/personal_gui/my_cosmetics/hats/clicked/select/buy/cookie
