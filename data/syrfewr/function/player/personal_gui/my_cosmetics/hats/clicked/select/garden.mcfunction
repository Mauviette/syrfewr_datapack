...
execute if entity @s[advancements={syrfewr:succes/skins/hats/garden=true}] run scoreboard players set @s s.SelectedHatID 5
...
execute if entity @s[advancements={syrfewr:succes/skins/hats/garden=false}] if score @s s.TimeSinceLastObjectSelection matches ..30 if score @s s.SelectedObjectID matches 1 if score @s s.credits >= #hat_epic price run function syrfewr:player/personal_gui/my_cosmetics/hats/clicked/select/buy/garden
