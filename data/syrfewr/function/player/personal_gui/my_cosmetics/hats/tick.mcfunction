...
execute if score @s s.GuiPageID matches 5 if score @s s.GuiIndexID matches 1 unless data entity @s {Inventory:[{Slot:15b,components:{"minecraft:custom_data":{select_rainbow:1}}}]} run function syrfewr:player/personal_gui/my_cosmetics/hats/clicked/select/rainbow
execute if score @s s.GuiPageID matches 5 if score @s s.GuiIndexID matches 1 unless data entity @s {Inventory:[{Slot:16b,components:{"minecraft:custom_data":{select_rainbow_lootbox:1}}}]} run function syrfewr:player/personal_gui/my_cosmetics/hats/clicked/select/lootbox
execute if score @s s.GuiPageID matches 5 if score @s s.GuiIndexID matches 1 unless data entity @s {Inventory:[{Slot:19b,components:{"minecraft:custom_data":{select_douglas:1}}}]} run function syrfewr:player/personal_gui/my_cosmetics/hats/clicked/select/douglas
execute if score @s s.GuiPageID matches 5 if score @s s.GuiIndexID matches 1 unless data entity @s {Inventory:[{Slot:20b,components:{"minecraft:custom_data":{select_unicorn:1}}}]} run function syrfewr:player/personal_gui/my_cosmetics/hats/clicked/select/unicorn