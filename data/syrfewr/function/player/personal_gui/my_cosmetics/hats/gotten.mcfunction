...
execute if entity @s[advancements={syrfewr:succes/skins/hats/dead_bush=true}] run scoreboard players add @s s.temp 1
execute if entity @s[advancements={syrfewr:succes/skins/hats/antenna=true}] run scoreboard players add @s s.temp 1
