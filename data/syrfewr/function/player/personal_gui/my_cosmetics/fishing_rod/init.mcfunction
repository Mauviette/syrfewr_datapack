...
item replace entity @s inventory.18 with barrier[custom_model_data={strings:['empty']},custom_data={ui:1,item_from_mc_fishing_rod:1,to_kill:1,back_cosmetic:1},item_name='{"color":"white","text":"Retour (mes cosmétiques)"}']
item replace entity @s inventory.26 with barrier[custom_model_data={strings:['my_cosmetics']},custom_data={ui:1,item_from_mc_fishing_rod:1,to_kill:1,my_cosmetics_fishing_rods:1},item_name='{"text":""}',hide_tooltip={}]
