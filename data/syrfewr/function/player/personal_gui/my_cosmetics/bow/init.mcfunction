...
execute if entity @s[advancements={syrfewr:succes/skins/bows/angelbow=true}] if score @s s.SelectedBowSkinID matches 4 run item replace entity @s inventory.5 with bow[custom_model_data=4,custom_data={item_from_mc_bow:1,to_kill:1,select_angelbow:1},item_name='{"color":"white","text":"Arc angélique"}',lore=['{"color":"dark_green","text":"Sélectionné","italic":false}','{"color":"dark_gray","text":"Débloqué en finissant le jump impossible.","italic":false}'],enchantments={levels:{"minecraft:protection":1},show_in_tooltip:false}]

#Appel du vent (windcaller) (coute 50)
execute if entity @s[advancements={syrfewr:succes/skins/bows/windcaller=false}] run item replace entity @s inventory.6 with bow[custom_model_data=5,custom_data={item_from_mc_bow:1,to_kill:1,select_windcaller:1},item_name='{"color":"#30b05f","text":"Appel du vent"}',lore=['{"color":"red","text":"Verrouillé","italic":false}','[{"color":"dark_gray","text":"Achetable pour ","italic":false},{"color":"gold","text":"50 crédits","italic":false}]','{"color":"dark_gray","text":"Double clic pour acheter.","italic":true}']]
execute if entity @s[advancements={syrfewr:succes/skins/bows/windcaller=true}] unless score @s s.SelectedBowSkinID matches 5 run item replace entity @s inventory.6 with bow[custom_model_data=5,custom_data={item_from_mc_bow:1,to_kill:1,select_windcaller:1},item_name='{"color":"#30b05f","text":"Appel du vent"}',lore=['[{"color":"dark_gray","text":"Acheté pour ","italic":false},{"color":"gold","text":"50 crédits","italic":false}]']]
execute if entity @s[advancements={syrfewr:succes/skins/bows/windcaller=true}] if score @s s.SelectedBowSkinID matches 5 run item replace entity @s inventory.6 with bow[custom_model_data=5,custom_data={item_from_mc_bow:1,to_kill:1,select_windcaller:1},item_name='{"color":"#30b05f","text":"Appel du vent"}',lore=['{"color":"dark_green","text":"Sélectionné","italic":false}','[{"color":"dark_gray","text":"Acheté pour ","italic":false},{"color":"gold","text":"50 crédits","italic":false}]'],enchantments={levels:{"minecraft:protection":1},show_in_tooltip:false}]