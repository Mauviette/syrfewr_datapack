...
execute if entity @s[advancements={syrfewr:succes/skins/bows/gun=false}] if score @s s.TimeSinceLastObjectSelection matches ..30 if score @s s.SelectedObjectID matches 3 if score @s s.credits >= #bow_epic price run function syrfewr:player/personal_gui/my_cosmetics/bow/clicked/select/buy/gun
