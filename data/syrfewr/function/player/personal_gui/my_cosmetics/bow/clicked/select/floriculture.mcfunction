...
execute if entity @s[advancements={syrfewr:succes/skins/bows/floriculture=true}] run scoreboard players set @s s.SelectedBowSkinID 7
...
execute if entity @s[advancements={syrfewr:succes/skins/bows/floriculture=false}] if score @s s.TimeSinceLastObjectSelection matches ..30 if score @s s.SelectedObjectID matches 7 if score @s s.credits >= #bow_rare price run function syrfewr:player/personal_gui/my_cosmetics/bow/clicked/select/buy/floriculture
