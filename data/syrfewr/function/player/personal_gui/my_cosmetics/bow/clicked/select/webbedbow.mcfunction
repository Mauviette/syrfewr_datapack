...
execute if entity @s[advancements={syrfewr:succes/skins/bows/webbedbow=true}] run scoreboard players set @s s.SelectedBowSkinID 10
...
execute if entity @s[advancements={syrfewr:succes/skins/bows/webbedbow=false}] if score @s s.TimeSinceLastObjectSelection matches ..30 if score @s s.SelectedObjectID matches 10 if score @s s.credits >= #bow_unusual price run function syrfewr:player/personal_gui/my_cosmetics/bow/clicked/select/buy/webbedbow
