...
execute if entity @s[advancements={syrfewr:succes/skins/victory_animation/chicken_rain=false}] if score @s s.TimeSinceLastObjectSelection matches ..30 if score @s s.SelectedObjectID matches 1 if score @s s.credits >= #victory_animation_epic price run function syrfewr:player/personal_gui/my_cosmetics/victory_animation/clicked/select/buy/chicken_rain
