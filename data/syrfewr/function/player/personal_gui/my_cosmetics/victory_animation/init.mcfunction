...
item replace entity @s inventory.18 with barrier[custom_model_data=3,custom_data={ui:1,item_from_mc_va:1,to_kill:1,back_cosmetic:1},item_name='{"color":"white","text":"Retour (mes cosmétiques)"}']
