...
item replace entity @s inventory.18 with barrier[custom_model_data=3,custom_data={ui:1,item_from_mc_main:1,to_kill:1,back:1},item_name='{"color":"white","text":"Retour (menu principal)"}']
...
item replace entity @s inventory.2 with nether_star[custom_data={ui:1,item_from_mc_main:1,to_kill:1,my_cosmetics_va:1},lore=['{"color":"gray","text":"Tous les modes de jeu","italic":false}'],item_name='{"text":"Animations de victoire"}']
item replace entity @s inventory.3 with leather_helmet[custom_data={ui:1,item_from_mc_main:1,to_kill:1,my_cosmetics_hats:1},lore=['{"color":"gray","text":"Lobby","italic":false}'],item_name='{"text":"Chapeaux"}',attribute_modifiers={modifiers:[{type:"generic.luck",id:"generic.luck",amount:0,operation:"add_value"}],show_in_tooltip:false}]
item replace entity @s inventory.26 with barrier[minecraft:custom_model_data=104,custom_data={ui:1,item_from_mc_main:1,to_kill:1,my_cosmetics:1},item_name='{"text":""}',hide_tooltip={}]
