...
execute if score @s s.GuiPageID matches 1 unless data entity @s {Inventory:[{Slot:11b,components:{"minecraft:custom_data":{my_cosmetics_va:1}}}]} run function syrfewr:player/personal_gui/my_cosmetics/main/clicked/my_victory_animations
execute if score @s s.GuiPageID matches 1 unless data entity @s {Inventory:[{Slot:12b,components:{"minecraft:custom_data":{my_cosmetics_hats:1}}}]} run function syrfewr:player/personal_gui/my_cosmetics/main/clicked/hats
