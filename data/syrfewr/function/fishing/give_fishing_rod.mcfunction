...
execute if score @s s.SelectedFishingRodSkinID matches 4 run give @s fishing_rod[custom_model_data=4,custom_data={fishing_rod:1,to_kill:1},minecraft:unbreakable={show_in_tooltip:false},item_name='{"color":"#553000","text":"Canne à pêche tordue"}',lore=['{"color":"gold","text":"Fragile","italic":false}']]
