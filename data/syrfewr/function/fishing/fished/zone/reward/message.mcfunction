...
execute if score @s s.temp matches 3 if entity @s[advancements={syrfewr:missions/rainbow_fish/1_unlock=false}] run tellraw @s {"text":"\"Pierre qui roule n'amasse pas mousse\"","italic": true}
execute if score @s s.temp matches 3 if entity @s[advancements={syrfewr:missions/rainbow_fish/1_claim=true}] run tellraw @s {"text":"\"Pierre qui roule n'amasse pas mousse\"","italic": true}

execute if score @s s.temp matches 4 if entity @s[advancements={syrfewr:missions/rainbow_fish/1_unlock=false}] run tellraw @s {"text":"\"Méfiez-vous de l'eau qui dort.\"","italic": true}
execute if score @s s.temp matches 4 if entity @s[advancements={syrfewr:missions/rainbow_fish/1_claim=true}] run tellraw @s {"text":"\"Méfiez-vous de l'eau qui dort.\"","italic": true}
...
execute if score @s s.temp matches 3..5 if entity @s[advancements={syrfewr:missions/rainbow_fish/1_unlock=true}] if entity @s[advancements={syrfewr:missions/rainbow_fish/1_claim=false}] run tellraw @s {"text":"...Il équipera la canne biscornue,\nEt, accompagné d'une nasse brillante,\nIl trouvera la truite luisante.","italic":true,"color":"gray"}
