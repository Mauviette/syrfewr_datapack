...
$data modify entity @s[type=item] Item.components."minecraft:custom_data".fish set from storage s.fish category.$(category)[$(id)].id
...
$data modify storage s.fished suffix set from storage s.fish category.$(category)[$(id)].fish_suffix
