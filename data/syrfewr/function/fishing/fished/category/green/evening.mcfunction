...
##Poissons
execute if score #random_type s.temp matches 1..74 unless score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 store result score #random_2 s.temp run random value 1..70
execute if score #random_type s.temp matches 1..74 if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 store result score #random_2 s.temp run random value 1..100
