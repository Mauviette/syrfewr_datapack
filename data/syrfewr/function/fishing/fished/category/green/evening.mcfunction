...
##Poissons
execute if score #random_type s.temp matches 1..69 unless score @p[scores={s.hasFished=1..}] s.fishingRodType matches 4 store result score #random_2 s.temp run random value 1..70
execute if score #random_type s.temp matches 1..69 if score @p[scores={s.hasFished=1..}] s.fishingRodType matches 4 store result score #random_2 s.temp run random value 1..100
...
#Sangsue
execute if score #random_2 s.temp matches 71.. if score @p[scores={s.hasFished=1..}] s.fishingRodType matches 4 run data modify storage s.fished id set value 4
execute if score #random_2 s.temp matches 71.. if score @p[scores={s.hasFished=1..}] s.fishingRodType matches 4 run data modify storage s.fished fish set from storage s.fish category.green[4].id
