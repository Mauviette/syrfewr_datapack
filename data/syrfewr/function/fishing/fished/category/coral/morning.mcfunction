...
execute if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 store result score #random_type s.temp run random value 1..105
...
##Poissons
execute if score #random_type s.temp matches 1..80 unless score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 2 unless score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 store result score #random_2 s.temp run random value 1..50
execute if score #random_type s.temp matches 1..80 if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 2 store result score #random_2 s.temp run random value 1..75
execute if score #random_type s.temp matches 1..80 if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 store result score #random_2 s.temp run random value 1..69
...
#Corail de feu (rr4)
execute if score #random_2 s.temp matches 76.. if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 run data modify storage s.fished id set value 1
execute if score #random_2 s.temp matches 76.. if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 run data modify storage s.fished fish set from storage s.fish category.coral[1].id

execute if score #random_2 s.temp matches 1.. run return fail

##Déchets
execute if score #random_type s.temp matches 81.. if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 store result score #random_2 s.temp run random value 1..2
