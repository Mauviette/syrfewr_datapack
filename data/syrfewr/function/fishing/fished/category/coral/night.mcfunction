...
execute if score #random_2 s.temp matches ..70 run data modify storage s.fished fish set from storage s.fish category.coral[3].id
...
execute if score #random_2 s.temp matches 1..50 run data modify storage s.fished fish set from storage s.fish category.coral[0].id
...
execute if score #random_2 s.temp matches 51.. if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 4 run data modify storage s.fished fish set from storage s.fish category.coral[1].id
