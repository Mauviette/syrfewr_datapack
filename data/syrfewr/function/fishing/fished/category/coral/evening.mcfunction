...
#---Lombric
execute if score @p[scores={s.hasFished=1..}] s.bait_effect matches 1 if score #random_2 s.temp matches ..50 store result score #random_2 s.temp run random value 50..80
