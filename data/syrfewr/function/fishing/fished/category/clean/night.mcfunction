...
#Poisson rouge
execute if score #random_2 s.temp matches 71..95 if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 2 run data modify storage s.fished id set value 2
execute if score #random_2 s.temp matches 71..95 if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 2 run data modify storage s.fished fish set from storage s.fish category.clean[2].id
