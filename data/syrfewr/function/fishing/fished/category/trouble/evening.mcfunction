...
##Poissons
execute if score #random_type s.temp matches 1..59 unless score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 3 store result score #random_2 s.temp run random value 1..110
execute if score #random_type s.temp matches 1..59 if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 3 store result score #random_2 s.temp run random value 1..130
...
#Brochet (rr3)
execute if score #random_2 s.temp matches 111.. if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 3 run data modify storage s.fished id set value 2
execute if score #random_2 s.temp matches 111.. if score @p[scores={s.hasFished=1..}] s.SelectedFishingRodSkinID matches 3 run data modify storage s.fished fish set from storage s.fish category.trouble[2].id
