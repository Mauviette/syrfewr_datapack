...
execute if score @s s.jean_peche_step matches 1 if entity @s[advancements={syrfewr:succes/fishing/mission/unlocked=true}] run data modify storage s.temp_dialog text set value '[{"text":"Comment puis-je t\'aider?\\n"},{"text":"- Un indice ","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1100"}},{"text":"(-10 crédits)\\n","color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1100"}},{"text":"- Le poisson secret","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1101"}}]'
execute if score @s s.jean_peche_step matches 1 if entity @s[advancements={syrfewr:succes/fishing/mission/unlocked=false}] run data modify storage s.temp_dialog text set value '[{"text":"Comment puis-je t\'aider?\\n"},{"text":"- Un indice ","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1100"}},{"text":"(-10 crédits)\\n","color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1100"}},{"text":"- Le poisson secret","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1101"}},{"text":"\\n- (!) Ma mission journalière","color":"blue","clickEvent":{"action":"run_command","value":"/trigger zEventTrigger set 1102"}}]'
