...
execute store result score #id_skin s.temp run random value 1..3
...
execute if score #id_skin s.temp matches 2 run function syrfewr:lootbox/trouvaille/skin/test_give {"type":"hats","skin":"dead_bush",rarity:"unusual"}
