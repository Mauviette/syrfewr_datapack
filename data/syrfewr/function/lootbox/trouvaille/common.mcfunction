...
execute if score #trouvaille s.temp matches 1..33 run scoreboard players set #trouvaille_id s.temp 1

execute if score #trouvaille s.temp matches 34..66 run scoreboard players add @s s.creditsToAddBonus 10
execute if score #trouvaille s.temp matches 34..66 run scoreboard players set #trouvaille_id s.temp 2

execute if score #trouvaille s.temp matches 67..90 run scoreboard players add @s s.creditsToAddBonus 15
execute if score #trouvaille s.temp matches 67..90 run scoreboard players set #trouvaille_id s.temp 3

execute if score #trouvaille s.temp matches 91.. run scoreboard players add @s s.add_unusual_lootboxes 1
execute if score #trouvaille s.temp matches 91.. run scoreboard players set #trouvaille_id s.temp 4