...
data modify storage s.fish category.trouble append value {name:'{"text":"Piranha","color":"#a2c4c7"}',custom_model_data:1025,id:"piranha",hint:'{"text":"Pêché n\\\'importe quand.","color":"gray","italic":false}',hour:0,type:0,credits:4,suffix:"",rod_required:0}
...
data modify storage s.fish category.coral append value {name:'{"text":"Corail bulle","color":"blue"}',custom_model_data:1014,id:"coral_bubble",hint:'{"text":"Pêché l\\\'après-midi.","color":"gray","italic":false}',hour:4,type:0,credits:2,suffix:"",rod_required:0}
...
data modify storage s.fish category.coral append value {name:'{"text":"Corail tube","color":"dark_purple"}',custom_model_data:1017,id:"coral_tube",hint:'{"text":"Pêché le soir.","color":"gray","italic":false}',hour:5,type:0,credits:3,suffix:"",rod_required:0}
