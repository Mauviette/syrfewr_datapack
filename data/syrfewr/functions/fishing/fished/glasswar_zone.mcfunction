...
#Boite de conserve
execute if score @s s.temp matches 1..5 run data merge entity @e[type=item,sort=nearest,limit=1] {Item:{components:{"minecraft:custom_model_data":1,"minecraft:custom_data":{fished:1,fish_id:1}}}}
#Algues
execute if score @s s.temp matches 6.. run data merge entity @e[type=item,sort=nearest,limit=1] {Item:{components:{"minecraft:custom_model_data":2,"minecraft:custom_data":{fished:1,fish_id:3}}}}


execute if score @s s.temp matches 1.. run return 0
## Poissons
execute if score @s s.temp2 matches 21.. store result score @s s.temp run random value 1..68
#Perche
...
#Flétan du pacifique
execute if score @s s.temp matches 62..68 run data merge entity @e[type=item,sort=nearest,limit=1] {Item:{components:{"minecraft:custom_model_data":1005,"minecraft:custom_data":{fished:1,fish_id:9}}}}
