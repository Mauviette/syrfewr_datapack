...
execute if score @s cp.MiniGameTimer matches 1988 as @a[distance=..300] at @s run function carlos_party:game/manager/minigames/carlos/dialog/piment_colorswap
