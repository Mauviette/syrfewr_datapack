...
execute if score @s cp.MiniGameAltTimer matches 2 if score @s cp.MiniGameTemp matches 1 run title @a[distance=..200] title [{"text":"Bleu","color":"blue","bold":true}]
...
execute if score @s cp.MiniGameTemp matches 1 run title @a[distance=..200] actionbar [{"text":"Bleu","color":"blue","bold":true}]
