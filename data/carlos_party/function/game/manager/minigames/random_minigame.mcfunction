execute store result score @s cp.MiniGameID run random value 1..5
...
#execute if score @s cp.MiniGameID matches 5 run function carlos_party:game/manager/minigames/anvil_drop/init_mode
