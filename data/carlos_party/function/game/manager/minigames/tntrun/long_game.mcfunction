...
execute if score @s cp.MiniGameTimer matches 1428.. as @a[distance=..300,tag=cp.tntrun] at @s run attribute @s generic.jump_strength modifier add cp.tntrun_long -1 add_multiplied_total