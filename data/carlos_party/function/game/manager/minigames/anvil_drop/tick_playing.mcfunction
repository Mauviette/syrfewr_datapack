...
#Spawn enclumes
execute if score @s cp.MiniGameTimer matches 200.. run function carlos_party:game/manager/minigames/anvil_drop/spawn_anvil
execute if score @s cp.MiniGameTimer matches 200.. if predicate syrfewr:random/0.3 run function carlos_party:game/manager/minigames/anvil_drop/spawn_anvil
stopsound @a[distance=..200] block
