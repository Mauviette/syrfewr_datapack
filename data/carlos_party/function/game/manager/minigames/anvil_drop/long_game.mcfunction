...
execute if score @s cp.MiniGameTimer matches 1188 as @a[distance=..300] at @s run function carlos_party:game/manager/minigames/carlos/dialog/template/piment

#Truc qui se passe
execute if score @s cp.MiniGameTimer matches 1218..