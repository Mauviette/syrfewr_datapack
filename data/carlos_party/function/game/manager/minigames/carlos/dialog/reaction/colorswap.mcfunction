...
execute if score $carlos.dialog s.temp matches 4 run tellraw @s ["",{"text":"<"},{"text":"Carlos","color":"dark_red"},{"text":"> J'aurais bien aimé inventer une couleur, mais c'est compliqué..."}]
