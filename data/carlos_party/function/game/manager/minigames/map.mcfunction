...
execute if score @s cp.MiniGameID matches 1.. if score @s cp.lastDialog matches 200.. if predicate syrfewr:random/0.001 run function carlos_party:game/manager/minigames/carlos/dialog/reaction/map
