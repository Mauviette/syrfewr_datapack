...
$execute if score @s tc.TowerEvolution matches 2 as @e[tag=tc.unit,distance=..$(range)] at @s unless score @s tc.EffectBurning matches 120.. run scoreboard players set @s tc.EffectBurning 120
