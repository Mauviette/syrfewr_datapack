...
execute if entity @s[tag=tc.unit_creeper] run playsound entity.explode hostile @a[distance=..20] ~ ~ ~
execute if entity @s[tag=tc.unit_creeper] run scoreboard players set @e[tag=tc.tower,distance=..4] tc.EffectSlow 80
