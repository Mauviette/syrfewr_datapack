...
execute if score @s tc.EffectSlow matches 1.. run scoreboard players operation #walk_speed s.temp *= 7 s.number
execute if score @s tc.EffectSlow matches 1.. run scoreboard players operation #walk_speed s.temp /= 10 s.number
