...
execute if score #item s.temp matches 1.. if score @s tc.ResourceCopper matches 15.. run scoreboard players remove @s tc.ResourceCopper 20
...
execute if score #item s.temp matches 1.. if score @s tc.ResourceCopper matches 25.. run scoreboard players remove @s tc.ResourceCopper 50
