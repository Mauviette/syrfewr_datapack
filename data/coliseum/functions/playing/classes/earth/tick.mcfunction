...
#execute unless score @s s.temp matches 1.. run give @s wooden_axe[item_name='{"color":"#82500F","text":"Batte sablonneuse"}',unbreakable={show_in_tooltip:false},custom_model_data={strings:['earth_rod']},custom_data={batte_rocheuse:1,to_kill:1},attribute_modifiers=[{type:"attack_speed",name:"attack_speed",amount:-3.15,operation:"add_value",id:"earth_rod",slot:"mainhand"},{type:"attack_damage",id:"attack_damage",amount:7,operation:"add_value"}],food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:300001}] 1
#
#
##Armure
...
#execute unless data entity @s {Inventory:[{Slot:100b,components:{"minecraft:custom_data":{elemental_armor:1}}}]} run item replace entity @s armor.feet with leather_boots[item_name='{"color":"#915119","italic":false,"text":"Bottes terreuses"}',unbreakable={show_in_tooltip:false},custom_data={elemental_armor:1,to_kill:1},attribute_modifiers={modifiers:[{type:"armor",name:"armor",amount:0,operation:"add_value",uuid:[I;143268698,2072661063,-1476030361,-657978360]}],show_in_tooltip:false},dyed_color={rgb:5715984,show_in_tooltip:false}]
#
...
#execute unless data entity @s {Inventory:[{Slot:101b,components:{"minecraft:custom_data":{elemental_armor:1}}}]} run item replace entity @s armor.legs with leather_leggings[item_name='{"color":"#915119","italic":false,"text":"Pantalons sales"}',unbreakable={show_in_tooltip:false},custom_data={elemental_armor:1,to_kill:1},attribute_modifiers={modifiers:[{type:"armor",name:"armor",amount:0,operation:"add_value",uuid:[I;143268698,2072661063,-1476030361,-657978360]}],show_in_tooltip:false},dyed_color={rgb:5715984,show_in_tooltip:false}]
#
...
#execute unless score @s ce.ElementStatus1 matches 1.. unless data entity @s {Inventory:[{Slot:102b,components:{"minecraft:custom_data":{elemental_armor:1}}}]} run item replace entity @s armor.chest with leather_chestplate[item_name='{"color":"#915119","italic":false,"text":"Plastron terreux"}',unbreakable={show_in_tooltip:false},custom_data={elemental_armor:1,to_kill:1},attribute_modifiers={modifiers:[{type:"armor",name:"armor",amount:0,operation:"add_value",uuid:[I;143268698,2072661063,-1476030361,-657978360]}],show_in_tooltip:false},dyed_color={rgb:5715984,show_in_tooltip:false}]
#
...
#execute if score @s ce.ElementStatus1 matches 1.. unless data entity @s {Inventory:[{Slot:102b,components:{"minecraft:custom_data":{elemental_armor:1}}}]} run item replace entity @s armor.chest with iron_chestplate[item_name='{"color":"#3B3B3B","italic":false,"text":"Renforcement rocheux"}',unbreakable={show_in_tooltip:false},custom_data={elemental_armor:1,to_kill:1},attribute_modifiers=[{type:"gravity",name:"gravity",amount:0.06,operation:"add_value",uuid:[I;166793309,170346066,-1729468804,788672710],slot:"chest"},{type:"armor",name:"armor",amount:12,operation:"add_value",uuid:[I;-225609160,2103265900,-1543194252,251857868],slot:"chest"},{type:"knockback_resistance",name:"knockback_resistance",amount:.5,operation:"add_value",uuid:[I;-691822611,517295379,-1453300289,1450063931],slot:"chest"}]]
#
##Pouvoirs
